...
![(Taken from Chapman 2020 -- please note that this is *not* figure one in this framework)](images/rasd-explanation-obfuscation-figure.png "Title: (Taken from Chapman 2020 – please note that this is not figure one in this framework)"){.lightbox #fig-1 fig-alt="Two generalisation methods: On the left, a geographic grid, where all records are referenced to the bottom left-hand (SE) corner; right, a metric grid where all records are referenced to the centroid" fig-align="left"}
