...
![Restricted Access Species Data Governance](images/rasd-fig-1.png "Title: Restricted Access Species Data Governance"){#fig-1 .lightbox fig-alt="Restricted Access Species Data Governance flowchart, indicating the RASD Framework defines the processes, governance and standards for data custidians, and by extension, data requestors" fig-align="left"}
